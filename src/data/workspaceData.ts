...
export const CASE_STUDIES: CaseStudy[] = [
  {
    ...
    stack: ['React Native', 'FastAPI', 'TensorFlow', 'Hugging Face', 'Docker', 'PostgreSQL'],
    results: [
  ...
  },
  {
    ...
    stack: ['Next.js', 'FastAPI', 'Hugging Face', 'Google Cloud Run', 'TypeScript'],
    thumbnailUrl:
  ...
  },
  {
    ...
    githubUrl: 'https://github.com/yasinwalum/attendance-management-face-recognition',
    thumbnailUrl:
...
export const CONTACT_EMAIL = appEnv.contactEmail;
export const CONTACT_PHONE_DISPLAY = appEnv.contactPhoneDisplay;
export const CONTACT_WHATSAPP = appEnv.contactWhatsapp;
export const CONTACT_LOCATION_LABEL = appEnv.contactLocationLabel;
export const CONTACT_LOCATION_QUERY = appEnv.contactLocationQuery;
export const CONTACT_FORM_ENDPOINT = resolveContactFormEndpoint(
  appEnv.contactFormEndpoint,
  CONTACT_EMAIL,
);
...
export const CONTACT_WHATSAPP_LINK = whatsappDigits ? `https://wa.me/${whatsappDigits}` : '#';
export const CONTACT_MAPS_LINK = `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(CONTACT_LOCATION_QUERY)}`;

function resolveContactFormEndpoint(endpoint: string | undefined, contactEmail: string) {
